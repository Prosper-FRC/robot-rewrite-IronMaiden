...
// NOTE: All offsets were calculated first from PhoenixTuner, then by publishing encoder values to SmartDashboard
// and adjusting as necessary (ergo the pluses and minuses).
